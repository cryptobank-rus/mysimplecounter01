...
const contractAddress = 'secret1a4830kkpdfvvywwkscqz3lnysuuqqq0frwye43';
...
// const contractAddress = prompt("Введите номер контракта:", "Контракт");
...
export default function App() {
  ...
  return (
    <div className="App">
      <center><h4>Кнопка контракта MySimpleCounter, Secret network, тестовая сеть Pulsar-2</h4>

      {!keplrReady ? 
          <h4>Ожидание подключения кошелька Keplr...</h4>
      : 
        <div>
          <p>
            <strong>Адрес вашего кошелька:</strong> {myAddress}
          </p>
          <p>
            <strong>Контракт:</strong> {contractAddress}
          </p>
          <p>
            <strong>Счётчик mysimplecounter:</strong> {count}
          </p>
          <p>
            <button onClick={increment}>Запуск контракта</button>
          </p>
        </div>
      }
      </center></div>
